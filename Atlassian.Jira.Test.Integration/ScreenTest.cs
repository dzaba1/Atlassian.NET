...
public class ScreenTest
{
    ...
    {
        var screenAvailableFields = await jira.Screens.GetScreenAvailableFieldsAsync(SCREEN_ID).ToArrayAsync();
    ...
    {
        var screenTabs = await jira.Screens.GetScreenTabsAsync(SCREEN_ID).ToArrayAsync();
    ...
    {
        var screenTabFields = await jira.Screens.GetScreenTabFieldsAsync(SCREEN_ID, SCREEN_TAB_ID).ToArrayAsync();
