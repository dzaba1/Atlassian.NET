...
public interface IJiraUserService
{
    ...
    /// <param name="token">Cancellation token for this operation.</param>
    IAsyncEnumerable<JiraUser> SearchUsersAsync(string query, JiraUserStatus userStatus = JiraUserStatus.Active, int maxResults = 50, int startAt = 0, CancellationToken token = default);
    ...
    /// <param name="token">Cancellation token for this operation.</param>
    IAsyncEnumerable<JiraUser> SearchAssignableUsersForIssueAsync(string username, string issueKey, int startAt = 0, int maxResults = 50, CancellationToken token = default);
    ...
    /// <param name="maxResults">The maximum results.</param>
    /// <param name="token">Cancellation token for this operation.</param>
    IAsyncEnumerable<JiraUser> SearchAssignableUsersForProjectAsync(string username, string projectKey, int startAt = 0, int maxResults = 50, CancellationToken token = default);
    ...
    /// <param name="token">Cancellation token for this operation.</param>
    IAsyncEnumerable<JiraUser> SearchAssignableUsersForProjectsAsync(string username, IEnumerable<string> projectKeys, int startAt = 0, int maxResults = 50, CancellationToken token = default);
